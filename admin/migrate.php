...
/** @var Xbscdm\Common\Configurator $configurator */
$configurator = new Xbscdm\Common\Configurator();

/** @var \XoopsModules\Xbscdm\Common\Migrate $migrator */
$migrator = new \XoopsModules\Xbscdm\Common\Migrate($configurator);
