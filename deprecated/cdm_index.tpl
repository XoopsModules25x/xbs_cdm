...
<table width="100%" class="outer" cellspacing='1'>
    ...
    <{section name=i loop=$sets}>
        <tr>
            ...
            <td align="CENTER" class="odd"><a href="index.php?codeSet=<{$sets[i].cd_set}>"><img src="<{$xoops_url}>/modules/cdm/images/b_browse.png" title="<{$lang_select}>"></a>&nbsp;<a href="cdm_meta_edit.php?codeSet=<{$sets[i].cd_set}>"><img src="<{$xoops_url}>/modules/cdm/images/b_edit.png"
                                                                                                                                                                                                                                                     title="<{$lang_edit}>"></a></td>
        </tr>
    <{/section}>
    <!-- end sets item loop -->
</table>
