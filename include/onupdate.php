 ...
 */
function xoops_module_pre_update_xbscdm(\XoopsModule $module)
{
 ...
 */
function xoops_module_update_xbscdm(\XoopsModule $module, $previousVersion = null)
{
    $moduleDirName      = basename(dirname(__DIR__));
