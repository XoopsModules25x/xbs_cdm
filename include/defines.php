...
function getCDMModConfigs() {
	...
	$Module =& XoopsModule::getByDirname(CDM_DIR);
	$config_handler =& xoops_gethandler('config');
	$CDMModuleConfig =& $config_handler->getConfigsByCat(0, $Module->getVar('mid'));
	return $CDMModuleConfig;
}
...
*/
define('CDM_DEF_LANG',str_pad(substr($_def_lang,0,6),6));
