...
<{section name=i loop=$sets}>
  <tr>
	...
	<td align="CENTER" class="odd"><a href="index.php?codeSet=<{$sets[i].cd_set}>"><img src="<{$xoops_url}>/modules/cdm/images/b_browse.png" title ="<{$lang_select}>"></a></td>
  </tr>
<{/section}>
<!-- end sets item loop -->
</table>
...
<div align="right">
<br>CDM © 2004-2005, <a href="http://xoobs.net" title="Click to see software author's web page" target="_blank">A Kitson.</a> UK.
</div>
