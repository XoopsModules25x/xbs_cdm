...
$modversion['sub'][0]['name'] = _MI_CDM_SMNAME1;
$modversion['sub'][0]['url']  = 'cdm_codes_list.php';

// Templates
$modversion['templates'][0]['file']        = 'cdm_list_codes.tpl';
$modversion['templates'][0]['description'] = 'Simple list of codes';
$modversion['templates'][1]['file']        = 'cdm_index.tpl';
$modversion['templates'][1]['description'] = 'Select and edit set of codes';
...
//$modversion['templates'][2]['file'] = 'cdm_db_update.tpl';
//$modversion['templates'][2]['description'] = 'Edit a code record';
...
$modversion['config'][0]['name']        = 'def_lang';
$modversion['config'][0]['title']       = '_MI_CDM_DEFLANGNAME';
$modversion['config'][0]['description'] = '_MI_CDM_DEFLANGNAMEDESC';
$modversion['config'][0]['formtype']    = 'select';
$modversion['config'][0]['valuetype']   = 'text';
$modversion['config'][0]['default']     = 'EN';
...
$modversion['config'][1]['name']        = 'def_codeset';
$modversion['config'][1]['title']       = '_MI_CDM_DEFCODESETNAME';
$modversion['config'][1]['description'] = '_MI_CDM_DEFCODESETNAMEDESC';
$modversion['config'][1]['formtype']    = 'text';
$modversion['config'][1]['valuetype']   = 'text';
$modversion['config'][1]['default']     = 'BASE';

// Blocks
$modversion['blocks'][0]['file']        = 'cdm_block_codelookup.php';
$modversion['blocks'][0]['name']        = _MI_CDM_BLOCK_CODELOOKUPNAME;
$modversion['blocks'][0]['description'] = _MI_CDM_BLOCK_CODELOOKUPDESC;
$modversion['blocks'][0]['show_func']   = 'b_cdm_codelookup_show';
$modversion['blocks'][0]['edit_func']   = 'b_cdm_codelookup_edit';
$modversion['blocks'][0]['options']     = 'COUNTRY|EN    |0|0'; //Setname | Language | Allow set change | Allow language change
$modversion['blocks'][0]['template']    = 'cdm_block_codelookup.tpl';
